...
def print_result(test_labels,test_preds):
    test_labels = np.array(test_labels)
    priors_predict = np.bincount(test_preds) / len(test_preds)
    priors_acc = np.bincount(test_labels) / len(test_labels)
    print(f"Test priors_predict: {priors_predict}")
    print(f"Test priors_acc: {priors_acc}")
